...
public class Registry {
    ...
    public static final RegistrySupplier<RecipeType<GrapeMashingRecipe>> GRAPE_MASHING = create("grape_mashing");
    public static final RegistrySupplier<RecipeSerializer<GrapeMashingRecipe>> GRAPE_MASHING_SERIALIZER = create("grape_mashing", GrapeMashingRecipe.Serializer::new);
